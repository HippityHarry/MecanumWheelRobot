...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <tr>
        <td  class="button" ontouchstart='sendButtonInput("MoveCar","11")' ontouchend='sendButtonInput("MoveCar","0")'><span class="arrows">Circle</span></td>
        <td></td>
        <td  class="button" ontouchstart='sendButtonInput("MoveCar","12")' ontouchend='sendButtonInput("MoveCar","0")'><span class="arrows">Drift</span></td>
      </tr>
      <tr/><tr/>
      <tr>
